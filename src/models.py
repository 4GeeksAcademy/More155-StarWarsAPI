...
class User(db.Model):
    ...
    liked_characters: Mapped[list["Liked_Characters"]] = relationship(
        "Liked_Characters", back_populates="user")
    liked_planets: Mapped[list["Liked_Planets"]] = relationship(
        "Liked_Planets", back_populates="user")
...
class Characters(db.Model):
    ...
    liked_by: Mapped[list["Liked_Characters"]] = relationship(
        "Liked_Characters", back_populates="character")
...
class Planets(db.Model):
    ...
    climate: Mapped[str] = mapped_column(
        String(40), nullable=False)  # or true cuz i lack data
    terrain: Mapped[str] = mapped_column(String(40), nullable=False)
    liked_by: Mapped[list["Liked_Planets"]] = relationship(
        "Liked_Planets", back_populates="planet")
...
class Liked_Characters(db.Model):
    ...
    user: Mapped["User"] = relationship(
        "User", back_populates="liked_characters")
    character: Mapped["Characters"] = relationship(
        "Characters", back_populates="liked_by")
...
class Liked_Planets(db.Model):
    ...
    planet: Mapped["Planets"] = relationship(
        "Planets", back_populates="liked_by")
